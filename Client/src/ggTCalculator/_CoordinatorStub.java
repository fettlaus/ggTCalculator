...
public class _CoordinatorStub extends org.omg.CORBA.portable.ObjectImpl implements ggTCalculator.Coordinator
{
  ...
  public int calculate (int timeout, int mindelay, int maxdelay, int minprocess, int maxprocess, int ggT, ggTCalculator.Log log) throws ggTCalculator.CoordinatorPackage.noStarter, ggTCalculator.CoordinatorPackage.alreadyRunning
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                return calculate (timeout, mindelay, maxdelay, minprocess, maxprocess, ggT, log        );
            } finally {
                _releaseReply ($in);
            }
  } // calculate
