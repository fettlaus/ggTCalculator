 ...
 implements ggTCalculator.CoordinatorOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("calculate", new java.lang.Integer (2));
    _methods.put ("finished", new java.lang.Integer (3));
    _methods.put ("terminationStart", new java.lang.Integer (4));
    _methods.put ("terminationStop", new java.lang.Integer (5));
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 2:  // ggTCalculator/Coordinator/calculate
       {
         try {
       ...
       case 3:  // ggTCalculator/Coordinator/finished
       {
         int r = in.read_long ();
         this.finished (r);
         out = $rh.createReply();
       ...
       case 4:  // ggTCalculator/Coordinator/terminationStart
       {
       ...
       case 5:  // ggTCalculator/Coordinator/terminationStop
       {
         boolean $result = false;
       ...
       case 6:  // ggTCalculator/Coordinator/quit
       {
         this.quit ();
         out = $rh.createReply();
         break;
