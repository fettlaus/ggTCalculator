...
public class CoordinatorImpl extends CoordinatorPOA {
    ...
    public void addProcess(String startername, int id, Process process) {
        ...
        System.out.println("Process " + startername + "-"
                + Integer.toString(id) + " connected");
    }
    ...
    @Override
    public int calculate(int timeout, int mindelay, int maxdelay,
        ...
        for (int i = 0; i < procs.length; i++) {
            ...
            procs[i].set_params(tmp_left, tmp_right, (ggT
                    * (rnd.nextInt(100) + 1) * (rnd.nextInt(100) + 1)), log,
