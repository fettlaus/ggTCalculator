 ...
 implements ggTCalculator.StarterOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("quitProcess", new java.lang.Integer (2));
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // ggTCalculator/Starter/getName
       {
         String $result = null;
         $result = this.getName ();
         out = $rh.createReply();
       ...
       case 1:  // ggTCalculator/Starter/createProcess
       {
       ...
       case 2:  // ggTCalculator/Starter/quitProcess
       {
         this.quitProcess ();
         out = $rh.createReply();
         break;
       ...
       case 3:  // ggTCalculator/Starter/quit
       {
         this.quit ();
         out = $rh.createReply();
         break;
