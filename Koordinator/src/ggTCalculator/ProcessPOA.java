 ...
 implements ggTCalculator.ProcessOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("_get_number", new java.lang.Integer (4));
    _methods.put ("_set_number", new java.lang.Integer (5));
    _methods.put ("_get_log", new java.lang.Integer (6));
    _methods.put ("_set_log", new java.lang.Integer (7));
    _methods.put ("_get_delay", new java.lang.Integer (8));
    _methods.put ("_set_delay", new java.lang.Integer (9));
    _methods.put ("_get_timeout", new java.lang.Integer (10));
    _methods.put ("_set_timeout", new java.lang.Integer (11));
    _methods.put ("_get_ready", new java.lang.Integer (12));
    _methods.put ("_set_ready", new java.lang.Integer (13));
    _methods.put ("terminate", new java.lang.Integer (14));
    _methods.put ("message", new java.lang.Integer (15));
    _methods.put ("stop", new java.lang.Integer (16));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 4:  // ggTCalculator/Process/_get_number
       {
         int $result = (int)0;
         $result = this.number ();
         out = $rh.createReply();
       ...
       case 5:  // ggTCalculator/Process/_set_number
       {
       ...
       case 6:  // ggTCalculator/Process/_get_log
       {
       ...
       case 7:  // ggTCalculator/Process/_set_log
       {
       ...
       case 8:  // ggTCalculator/Process/_get_delay
       {
       ...
       case 9:  // ggTCalculator/Process/_set_delay
       {
       ...
       case 10:  // ggTCalculator/Process/_get_timeout
       {
         int $result = (int)0;
         $result = this.timeout ();
         out = $rh.createReply();
       ...
       case 11:  // ggTCalculator/Process/_set_timeout
       {
       ...
       case 12:  // ggTCalculator/Process/_get_ready
       {
       ...
       case 13:  // ggTCalculator/Process/_set_ready
       {
       ...
       case 14:  // ggTCalculator/Process/terminate
       {
         boolean $result = false;
       ...
       case 15:  // ggTCalculator/Process/message
       {
       ...
       case 16:  // ggTCalculator/Process/stop
       {
         this.stop ();
         out = $rh.createReply();
         break;
